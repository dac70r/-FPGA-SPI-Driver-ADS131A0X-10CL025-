...
#define CONFIG_PAIR 			4
#define SPI_TIMEOUT_MAX 		10000UL  // Adjust depending on expected speed and system clock
#define AIN_COFFECIENT_CURRENT 	9.7035e-7
#define AIN_COFFECIENT_VOLTAGE ((201.0 / 8.8) * (2.442 / 8388608))


static alt_u32 ADC1_data[4] = {0x0000, 0x0000, 0x0000, 0x0000};
static alt_u32 ADC2_data[4] = {0x0000, 0x0000, 0x0000, 0x0000};
static alt_u32 ADC3_data[4] = {0x0000, 0x0000, 0x0000, 0x0000};
static alt_u32 ADC4_data[4] = {0x0000, 0x0000, 0x0000, 0x0000};
